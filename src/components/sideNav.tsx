...
export default function SideNav({ open, onClose }: { open: boolean, onClose: () => void }) {
    return (
      ...
      >
        <button className="ml-5 text-white text-2xl w-1 h-1 opacity-90 rounded-full bg-[#ff0000]/80 hover:scale-108 shadow-[0_10px_20px_rgba(0,0,0,0.3)] transition-all duration-300 cursor-pointer" onClick={onClose}>✕</button>
